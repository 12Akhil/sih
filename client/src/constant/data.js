export const navData = [
    { url: 'https://media.istockphoto.com/id/1318404203/vector/kashmir-map-black-outline-with-shadow-on-white-background.jpg?s=612x612&w=0&k=20&c=V4R1Y7qLYsST7880Y8p-3yJkP0a6kfLJIc4LSz661Ps=', text: 'Jammu n Kashmir' },
    { url: 'https://www.burningcompass.com/countries/india/maps/bihar-outline-map.jpg', text: 'Bihar' },
    { url: 'https://www.burningcompass.com/countries/india/maps/west-bengal-outline-map.jpg', text: 'West Bengal' },
    { url: 'https://www.burningcompass.com/countries/india/maps/maharashtra-outline-map.jpg', text: 'Maharashtra' },
    { url: 'https://media.istockphoto.com/id/1318403613/vector/karnataka-map-black-outline-with-shadow-on-white-background.jpg?s=170667a&w=0&k=20&c=59Z1dzLf5e5vBivnCsljUALfr0eUZMBVvQTGov3P6KA=', text: 'Karnataka ' },
    { url: 'https://www.burningcompass.com/countries/india/maps/rajasthan-outline-map.jpg', text: 'Rajasthan' },
    { url: 'https://www.burningcompass.com/countries/india/maps/uttar-pradesh-outline-map.jpg', text: 'Uthar Pradesh' },
    { url: 'https://www.nicepng.com/png/detail/947-9473896_kerala-map-png-line-art.png', text: 'Kerala' },
    { url: 'https://e1.pxfuel.com/desktop-wallpaper/605/739/desktop-wallpaper-tamil-nadu-outline-map-tamil-nadu-blank-map-tamil-nadu-map.jpg', text: 'Tamil Nadu' }
];
